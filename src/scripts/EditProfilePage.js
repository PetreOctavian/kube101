function validare() {
    ...
    var email = document.getElementsByName('edit_email').value;
    var password = document.getElementsByName('edit_pass').value;
    var repassword = document.getElementsByName('edit_repass').value;
    var firstname = dodocument.getElementsByName('edit_fname').value;
    var lastname = document.getElementsByName('edit_lname').value;
    var address = document.getElementsByName('edit_add').value;
    var telephone = document.getElementsByName('edit_tel').value;
